...
public class HelloFLUIJavaServer extends AbstractHandler{
	private FLUIScreenManager screenManager = HelloScreenManager.createScreenManager();
	...
	public static void main(String[] args) throws Exception {
		...
		server.setHandler(new HelloFLUIJavaServer());
		server.start();
		server.join();
	}
}
