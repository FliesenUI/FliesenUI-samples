...
public class FLUITestClassWriter {
	...
	private StringBuilder writeTestStepMethod(int step, FLUIRequest request, FLUIReplyDTO reply) throws Exception {
		...
		result.append("        FLUIReplyDTO realResult = screenManager.onScreenRequest(request, null, null);\n");
		result.append("        realResult.setRecordedActions(new ArrayList<FLUIReplyAction>()); //: ignored recorded actions\n");
		...
		result.append("\n");
		result.append("        expectedReply.getReplyDTO().setRecordedActions(new ArrayList<FLUIReplyAction>()); //: ignored recorded actions\n");
