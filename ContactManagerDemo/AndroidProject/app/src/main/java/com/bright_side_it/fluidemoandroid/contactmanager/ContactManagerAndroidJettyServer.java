...
public class ContactManagerAndroidJettyServer extends AbstractHandler {
	...
	public ContactManagerAndroidJettyServer(Context context, int port, FLUIScreenManagerAndroid screenManager){
	...
	public void startServer() throws Exception {
		...
		new Thread(){
			...
			public void run() {
				...
				server.setHandler(new ContactManagerAndroidJettyServer(context, port, screenManager));
				try {
					server.start();
					server.join();
				} catch (Exception e) {
